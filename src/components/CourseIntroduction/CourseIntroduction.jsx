...
const CourseIntroduction = () => {
  return (
    <div className="pb-6 md:py-10 px-5 md:px-28">
      <div className="flex items-center">
        <img src={introIcon} className="w-4 h-4 ml-4" />
        <h2 className="text-lg font-semibold">معرفی دوره</h2>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center p-4 md:p-7 relative">
        ...
        <div className="bg-primaryColor rounded-full p-4 w-80 h-80 mt-16 md:mt-25 md:mt-0 md:mt-0">
